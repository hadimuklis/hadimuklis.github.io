    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="http://localhost/multi_user/image/avatar_default.png" alt="Logo" width="50"></a>
                <a class="navbar-brand hidden" href="./"><img src="http://localhost/multi_user/image/avatar_default.png" alt="Logo"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="http://localhost/multi_user/halaman_siswa.php"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                     <li>
                        <a href="http://localhost/multi_user/jadwal_ujian.php"> <i class="menu-icon fa fa-calendar"></i>Jadwal Ujian</a>
                    </li>
                  <li>
                        <a href="http://localhost/multi_user/download_modul.php"> <i class="menu-icon fa fa-download"></i>Download Modul</a>
                    </li>
                    </li>
                        <li>
                        	<a href="upload_tugas.php"> <i class="menu-icon fa fa-upload"></i>Upload Tugas</a>
                        	</li>
                        	<li>
                        <a href="http://localhost/multi_user/video_pembelajaran.php"> <i class="menu-icon fa fa-youtube"></i>Video Pembelajaran</a>
                    </li>
                    <li>
